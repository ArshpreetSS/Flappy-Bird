...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird - Made by Arsh')
    ...
    GAME_SPRITES['message'] = pygame.image.load(
        'gallery/sprites/messages.png'
    ).convert_alpha()

    GAME_SPRITES['base'] = pygame.image.load(
        'gallery/sprites/base.png'
    ).convert_alpha()
